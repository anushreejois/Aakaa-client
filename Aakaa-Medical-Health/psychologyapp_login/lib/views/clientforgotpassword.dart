    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: GoogleFonts.outfit(color: const Color(0xFF065643).withValues(alpha: 0.5)),
          prefixIcon: Icon(Icons.email_outlined, color: const Color(0xFF065643).withValues(alpha: 0.6), size: 22),
      ...
      builder: (context) => Dialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const CircularProgressIndicator(color: Color(0xFF065643), strokeWidth: 3),
